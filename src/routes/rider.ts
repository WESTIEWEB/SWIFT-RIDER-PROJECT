...
import { registerRider, updateRiderProfile, VerifyUser, ResendOTP, getAllBiddings, acceptBid, RiderHistory, getRiderProfile, getUserOrderById, getOrderOwnerNameById, VerifyDeliveryOtp, DeliveryResendOTP, RiderEarnings, getMyCompletedRides, getAcceptedBid } from '../controller/riderController';
